...
class Pregenerator:
    ...
    def generate_primer_melody(self, matrix_tuple, bars):
        '''
        This method generates our primer melody by implementing a one-step Markov chain.
        INPUTS:
    ...
    def generate_backing_chords(self, chord_dictionary, bars):
        '''
        This method generates the primer chord to be used as input by Polyphony RNN.

        INPUT: 
        chord_dictionary: dictionary with chords and probability. {chord: probability}
