...
'''
    ...
    def get_note_matrix(self):
        '''
        This method returns a matrix with the probability of occurrence of notes in a melody.
        '''
        return NoteDistribution.get_note_matrix(self.scores)

    def get_chord_matrix(self):
        '''
        This method returns a matrix with the probability of occurrence of chords in a song.
        '''
