...
class EasyMusicGenerator:
    ...
    def generate(self):
        ...
        command = 'improv_rnn_generate --config=chord_pitches_improv --bundle_file=' + BUNDLE_PATH + ' --output_dir=' + OUTPUT_PATH + ' --num_outputs=1 --primer_melody="' + primer_string + '" --backing_chords=' + str(backing_string) + ' --render_chords --num_steps=128'
